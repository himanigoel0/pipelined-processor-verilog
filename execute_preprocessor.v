...
// All these outputs are sequential:
always @(posedge clk or posedge rst) begin
    if (rst) begin
        ...
        if (enable_ex) begin
            ...
            // aluin2:
            if (control_in[3] && (control_in[2:0] == 3'b001)) aluin2 <= imm;                    // Arith_logic
            else if ((control_in[3] == 0) && (control_in[2:0] == 3'b001)) aluin2 <= src2;       // Arith_logic
            else if (control_in[3] && (control_in[2:0] == 3'b101)) aluin2 <= mem_data_read_in;  // Mem Read
            
            // operation_out and opselect_out:
            operation_out <= control_in[6:4];
            opselect_out <= control_in[2:0];
            
            // shift_number, opselect = shift_reg: 
            ...
            // enable_shift, opselect = shift_reg:
...
// Because they are combinational:
